...
if (nat.ne.2) stop "The number of atoms must be 2, Na-Na"
...
dipole(3,1,2)=dcmplx(kk,0.d0)
dipole(3,2,1)=dconjg(dipole(1,1,2))
...
dipole(3,2,3)=dcmplx(kk,0.d0)
dipole(3,3,2)=dconjg(dipole(2,2,3))
