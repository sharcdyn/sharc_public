...
write(6,*) "Floquet Approximation with 4 potentials"
write(6,*) "Pot 1 -> V1"
write(6,*) "Pot 2 -> V2-0.08055"
write(6,*) "Pot 3 -> V3-0.08055-0.03606"
write(6,*) "Pot 4 -> V2-0.03606"

if (nat.ne.2) stop "Model for Na2, 2 atoms"
if (npot.ne.4) stop "Model for RWA with 4 potentials"
...
if (npot.ne.4) stop "Only available for 4 potentials"
...
dipole(1,3,4)=dcmplx(kk,0.d0)

 dipole(1,2,1)=dconjg(dipole(1,1,2))
 dipole(2,3,2)=dconjg(dipole(2,2,3))
 dipole(1,4,3)=dconjg(dipole(1,3,4))
 dipole(2,4,1)=dconjg(dipole(2,1,4))
